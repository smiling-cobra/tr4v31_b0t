...
- Crisis Resources: Static escalation text appended by application logic for very low mood; it is not generated by the LLM.
...
- If the mood score is 2 or lower, crisis resources are appended after the guidance text.
